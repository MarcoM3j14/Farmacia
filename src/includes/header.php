...
<body>
    <div class="wrapper ">
        <div class="sidebar" style="background-color: #8BD7D2;">
            <div class="logo bg-primary"><center><img src="../assets/img/banner.png" width="148"> </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="../"><b>Sistema de Ventas</b></a>
                    </div>
